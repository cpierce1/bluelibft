...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/18 22:15:58 by cpierce           #+#    #+#              #
#    Updated: 2019/09/26 23:45:23 by cpierce          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c \
			...
			ft_strncpy.c ft_strlcat.c ft_strchr.c ft_strrchr.c ft_strstr.c \
			ft_strndup.c ft_strnstr.c ft_strcmp.c ft_strncmp.c ft_atoi.c \
			...
			ft_lstdel.c ft_lstadd.c ft_lstiter.c ft_lstmap.c ft_strcat.c \
			ft_strncat.c ft_touporlow.c
...
OBJECTS = ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
		  ...
		  ft_strncpy.o ft_strlcat.o ft_strchr.o ft_strrchr.o ft_strstr.o \
		  ft_strndup.o ft_strnstr.o ft_strcmp.o ft_strncmp.o ft_atoi.o \
		  ...
		  ft_lstdel.o ft_lstadd.o ft_lstiter.o ft_lstmap.o ft_strcat.o \
		  ft_strncat.o ft_touporlow.o
